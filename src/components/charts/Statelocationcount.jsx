...
const employeeData = [
  { state: "California", CareGivers: 40, KeyPlayers: 25 },
  { state: "Texas", CareGivers: 30, KeyPlayers: 20 },
  { state: "New York", CareGivers: 35, KeyPlayers: 28 },
  { state: "Florida", CareGivers: 20, KeyPlayers: 15 },
  { state: "Illinois", CareGivers: 25, KeyPlayers: 18 },
];

const Statelocationcount = () => {
  return (
    <div className="bg-card dark:bg-dm-card p-6 rounded-xl shadow-md flex flex-col text-gray-900 dark:text-gray-100">
      {/* Heading */}
      <h3 className="text-lg font-bold mb-1">
        Employee Numbers – Care Givers / Key Players – Location
      </h3>

      {/* Subtext */}
      <p className="text-xs mb-4 text-gray-600 dark:text-gray-400">
        Distribution of Care Givers and Key Players by state
      </p>
...
export default Statelocationcount;
